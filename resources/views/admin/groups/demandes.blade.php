                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        Liste des Demandes de Partenariats
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-style mb-30">
                            <h6 class="mb-10">Liste des Demandes de Partenariats </h6>
                                    ...
                                    <tbody>
                                        @foreach ($demandes as $demande)
                                            <tr>
                                                ...
                                                @endphp
                                                <td>{{ $demande->id }}</td>
                                                <td>{{ $demande->school->name }}</td>
                                                <td>{{ $demande->school->email }}</td>
                                                <td>{{ $demande->school->phone }}</td>
                                                <td>
                                                    @if ($demande->status != 2)
                                                        <a href="{{ url('admin/partenariat/' . $demande->id) }}">
