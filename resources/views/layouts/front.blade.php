...
<head>
    ...
    <title>GESTA</title>
    <link rel="shortcut icon" href="{{ asset('front/images/logo/logo-ico.png') }}" type="image/x-icon" />
...
<body>
            ...
            <div class="flex -mx-4 items-center justify-between relative">
                <div class="px-4 w-60 max-w-full">
                    <a href="{{ route('home') }}" class="navbar-logo w-full block py-5">
                        <img src="{{ asset('front/images/logo/logo-white.png') }}" alt="logo"
                      ...
                      ">
                                        ...
                                        @if ($user)
                                            @if ($user->unreadNotifications->count() > 0)
                                                <span
                                                    class="inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 text-white rounded ml-2">{{ $user->unreadNotifications->count() }}</span>
                                            @endif
                                        @endif
                                    </a>
                                </li>
    ...
    <footer class="bg-black pt-20 lg:pt-[120px] relative z-10 wow fadeInUp" data-wow-delay=".15s">
        <div class="container">
            <div class="flex justify-center flex-wrap -mx-4">
                <div class="w-full sm:w-full md:w-full lg:w-full xl:w-full px-4 justify-center">
                    <div class="w-full mb-10 justify-center text-center">
                        ...
                        <div class="flex justify-center text-center items-center -mx-3">
    ...
    <script src="{{ asset('plugins/custom/dismissable-notification/notification.js') }}"></script>
