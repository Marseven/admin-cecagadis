...
class SaleController extends BasicController
{
    ...
    public function certificat($contract)
    {
        $contract = Contract::find($contract);
        $contract->load(['intern']);
        $date = new \DateTime();
        ...
        return $pdf->download('certificat-' . $contract->intern->lastname . '.pdf');
    }
    ...
    public function contract($contract)
    {
        ...
        return $pdf->download('contrat-' . $contract->intern->lastname . '.pdf');
    }
}
